const pages = {
  about: {
    ...
    sections: [['플레이 방식', '회원가입 없이 게임을 시작할 수 있으며, 최고 점수·즐겨찾기·최근 플레이는 사용 중인 브라우저에만 저장됩니다.'], ['접근성과 품질', '키보드 조작, 터치 조작, 포커스 표시, 움직임 줄이기 설정을 고려해 게임을 점검합니다. 문제가 있으면 정식 문의 채널을 통해 알려줄 수 있습니다.'], ['현재 상태', '이 사이트는 공개 전 품질 점검 단계입니다. 브랜드, 운영자 정보, 도메인은 정식 공개 전에 확정합니다.']],
  },
  contact: {
    title: 'Contact',
